(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["v-tag-select"] = factory();
	else
		root["v-tag-select"] = factory();
...
var __WEBPACK_AMD_DEFINE_RESULT__;/*! JRoll v2.6.5 ~ (c) 2015-2018 Author:BarZu Git:https://github.com/chjtx/JRoll Website:http://www.chjtx.com/JRoll/ */
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("f908");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"76c676fe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/select/src/main.vue?vue&type=template&id=1d4d539b&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"v-select-container",staticStyle:{"height":"100%","width":"100%"}},[_c('div',{staticClass:"q-select",class:[(_vm.layer || _vm.mlayer)?'active':'']},[_c('div',{staticClass:"q-select-right",on:{"click":function($event){$event.stopPropagation();return _vm.rClick($event)}}},[_c('i',{staticClass:"iconfont",class:[(_vm.layer || _vm.mlayer)?'icon-arrow-up':'icon-arrow-down']})]),_c('div',{staticClass:"q-select-left"},[_c('div',{staticClass:"q-select-input",attrs:{"placeholder":_vm.placeholder,"contenteditable":_vm.fixSearch()},on:{"click":function($event){$event.stopPropagation();return _vm.lClick($event)},"input":function($event){$event.stopPropagation();return _vm.input($event)},"focus":function($event){$event.stopPropagation();return _vm.focus($event)}}}),_c('label',{staticClass:"q-select-hover"})])]),(_vm.layer)?_c('div',{staticClass:"q-select-layer",class:[_vm.layerStyle.bottom?'bottom':'top'],style:({width:_vm.layerStyle.width + 'px',top:_vm.layerStyle.top + 'px',left:_vm.layerStyle.left + 'px','--end':_vm.layerStyle.end + 'px','--start':_vm.layerStyle.start + 'px','max-height':_vm.layerStyle.height+'px','height':_vm.layerStyle.height+'px','z-index':_vm.zIndex})},[_c('ul',{on:{"click":function($event){$event.stopPropagation();return _vm.liClick($event)}}},[(_vm.search)?_c('li',{directives:[{name:"show",rawName:"v-show",value:(!_vm.regex),expression:"!regex"}],staticClass:"compare",class:[!_vm.regex?'only-last-li':'']},[_c('div',{staticClass:"op-left"},[_vm._v("无筛选匹配数据")])]):_vm._e(),(_vm.empty && _vm.layerStyle.bottom)?_c('li',{directives:[{name:"show",rawName:"v-show",value:((_vm.model.indexOf('s') < 0)),expression:"(model.indexOf('s') < 0)"}],staticClass:"empty"},[_c('div',{staticClass:"op-left"},[_vm._v("请选择")])]):_vm._e(),_vm._l((_vm.options),function(item,index){return [_c('li',{directives:[{name:"show",rawName:"v-show",value:(!(item.visible == false)),expression:"!(item.visible == false)"}],key:item.text,class:[item.checked?'active':'',!(item.visible == false)?'visible':'unvisible'],attrs:{"val":JSON.stringify(item),"index":index}},[_c('div',{staticClass:"op-right"},[_c('i',{staticClass:"iconfont",class:[item.checked?'icon-checkbox-checked':'icon-checkbox']})]),_c('div',{staticClass:"op-left"},[_vm._v(_vm._s(item.text))])])]}),(_vm.empty && !_vm.layerStyle.bottom)?_c('li',{directives:[{name:"show",rawName:"v-show",value:((_vm.model.indexOf('s') < 0)),expression:"(model.indexOf('s') < 0)"}],staticClass:"empty"},[_c('div',{staticClass:"op-left"},[_vm._v("请选择")])]):_vm._e()],2)]):_vm._e(),(_vm.mlayer)?_c('div',{staticClass:"m-q-select-layer",style:({height:_vm.mlayerHeight+'px'}),on:{"touchstart":_vm.ts}},[_c('div',{staticClass:"m-layer-container"},[_c('div',{staticClass:"m-layer-content"},[_c('div',{staticClass:"m-layer-botton"},[_c('div',{staticClass:"confirm",on:{"click":function($event){$event.stopPropagation();return _vm.confirm($event)}}},[_vm._v("确 定")]),_c('div',{staticClass:"cancel",on:{"click":function($event){$event.stopPropagation();return _vm.cancel($event)}}},[_vm._v("取 消")])]),_c('div',{staticClass:"m-layer-wrapper"},[_c('ul',[_c('li'),_c('li'),_vm._l((_vm.options),function(val,index){return [_c('li',{key:val.text,class:[val.checked?'m-checked':'m-unchecked'],attrs:{"val":JSON.stringify(val),"index":index},on:{"click":function($event){$event.stopPropagation();return _vm.mLiClick($event)}}},[_vm._v(_vm._s(val.text))])]}),_c('li'),_c('li')],2)]),_c('div',{staticClass:"m-layer-line"})])])]):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/select/src/main.vue?vue&type=template&id=1d4d539b&
...
// EXTERNAL MODULE: ./node_modules/jroll/src/jroll.js
var jroll = __webpack_require__("586c");
var jroll_default = /*#__PURE__*/__webpack_require__.n(jroll);
  ...
  methods: {
    cancel: function cancel() {
      ...
      if (_tmp) {
        ...
        var chk_text = _tmpArray.reduce(function (a, b) {
          return a + "," + b.text;
        }, "");
    ...
    trigger: function trigger(index, isClick) {
      var _t = this,
          _list = this.options,
      ...
      if (_t.multy) {
        if (isClick) {
          _t.$set(_current, "checked", !_current.checked);
        }
      } else {
        ...
        _t.$set(_current, "checked", !0);
      }
    },
    mLiClick: function mLiClick(e) {
      var _t = this,
          _l = e.target,
          _offset = 0;

      var _index = _l.getAttribute("index");
    ...
    input: function input(e) {
      ...
      _list.forEach(function (item) {
        if (item.text.indexOf(_val) > -1) {
          _count += 1;

          _t.$set(item, "visible", true);
        } else {
          _t.$set(item, "visible", false);
        }
      });
      ...
      var _p = _t.offset(_t.storageTarget);
      ...
      if (!_t.layerStyle.bottom) {
        ...
        if (_t.ie()) {
          ...
          _t.$set(_t.layerStyle, "top", _p.top);
        } else {
          _t.$set(_t.layerStyle, "end", _p.top);
        }
      }
      ...
      var _h = _count * _t.oHeight + _count;

      if (_t.ie()) {
        _h += 1;
      }

      _t.$set(this.layerStyle, "height", _h);

      _t.$nextTick(function () {
        var _tList = _t.layerTarget.querySelectorAll("li");

        var _tLength = _tList.length,
            _lastShowLi;

        for (var _tl = 0; _tl < _tLength; _tl++) {
    ...
    chkResult: function chkResult() {
      var _this = this,
          _list = this.options;

      var _cValArray = _list.filter(function (item) {
        return item.checked;
      });

      var chk_text = _cValArray.reduce(function (a, b) {
        return b.checked ? a + "," + b.text : "";
      }, "");

      chk_text = chk_text && chk_text.substring(1, chk_text.length);
      _this.inputTarget.innerText = chk_text;

      _this.storageTarget.setAttribute("checked-val", JSON.stringify(_cValArray));
    },
    liClick: function liClick(e) {
      ...
      var _index = _li.getAttribute("index"),
      ...
      if (!_t.multy) {
        _list.forEach(function (item) {
          item.checked && _t.$set(item, "checked", !!0);
        });
    ...
    layerdom: function layerdom() {
      ...
      var _lList = document.querySelectorAll(".q-select-layer"),
          _lCount = _lList.length,
          _lActive;

      for (var _tl = 0; _tl < _lCount; _tl++) {
    ...
    lClick: function lClick(e) {
      ...
      var _chkVal = _t.storageTarget.getAttribute("checked-val");

      var _has = document.querySelector(".q-select.active");
      ...
      if (_has) {
        if (_t.layerTarget && _t.layerTarget["target"] && _t.layerTarget["target"].isSameNode(_t.storageTarget)) {
          return;
        }

        var _tList = document.querySelectorAll(".q-select-layer"),
        ...
        _has.querySelector(".iconfont").className = _has.querySelector(".iconfont").className.replace("icon-arrow-up", "icon-arrow-down");

        var _val = _has.getAttribute("checked-val");

        if (_val) {
          var _valArray = JSON.parse(_val);

          var chk_text = _valArray.reduce(function (a, b) {
            return a + "," + b.text;
          }, "");
      ...
      if (_chkVal) {
        var _chkArray = JSON.parse(_chkVal);

        _list.forEach(function (item, indx) {
          _t.$set(item, "checked", !!0);

          _chkArray.forEach(function (c_item) {
      ...
      if (window.innerWidth < 769) {
        ...
        _t.$nextTick(function () {
          var _layer = _t.layerdom();

          _t.layerTarget = _layer;
          _t.mJroll = new jroll_default.a(".m-layer-wrapper");
          /* 第一次展示，则默认显示第一个li内容 */
      ...
      _t.$nextTick(function () {
        ...
        _t.$nextTick(function () {
          ...
          document.removeEventListener("click", _t.close);
          document.addEventListener("click", _t.close);
    ...
    offset: function offset(elem) {
      ...
      while (elem && elem != document.body) {
        ...
        if (elem) {
          var _b_t = parseInt(elem.style.borderTopWidth),
              _b_l = parseInt(elem.style.borderLeftWidth);

          obj.top += isNaN(_b_t) ? 0 : _b_t;
          obj.left += isNaN(_b_l) ? 0 : _b_l;
          obj.left += elem.offsetLeft;
          obj.top += elem.offsetTop;
        }
      }

      obj.top = obj.top - this.scrollTop();
      return obj;
    },
    extend: function extend() {
      ...
      if (typeof_typeof(target) != "object" && typeof target != "function") {
        target = {};
      }
    ...
    isHidden: function isHidden(ele) {
      var _style = window.getComputedStyle(ele);

      return _style.display === 'none';
    },
    fixSearch: function fixSearch() {
      var _t = this;
    ...
    bodyScroll: function bodyScroll() {
      ...
      var _l = document.querySelectorAll(".q-select-layer"),
          _lCount = _l.length,
          _lActive;
      ...
      var _target = _lActive ? _lActive["target"] : null;

      if (_target) {
        var _p = _t.offset(_target),
            _fix = 0,
...
// EXTERNAL MODULE: ./packages/select/src/main.vue?vue&type=style&index=0&lang=css&
var mainvue_type_style_index_0_lang_css_ = __webpack_require__("88cd");
...
main.install = function (Vue) {
  Vue.component(main.name, Select);
};

/* harmony default export */ var packages_select = (main);
// CONCATENATED MODULE: ./packages/index.js

// 导入单个组件
 // 以数组的结构保存组件，便于遍历

var components = [packages_select]; // 定义 install 方法
...
//# sourceMappingURL=v-tag-select.umd.js.map