...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"0eb70e42-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/select/src/main.vue?vue&type=template&id=7aba917c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"v-select-container",staticStyle:{"height":"100%","width":"100%"},attrs:{"id":'m-'+_vm.id}},[_c('div',{staticClass:"q-select",class:[(_vm.layer || _vm.mlayer)?'active':''],attrs:{"checked-val":_vm.initVal}},[_c('div',{staticClass:"q-select-right",on:{"click":function($event){$event.stopPropagation();return _vm.rClick($event)}}},[_c('i',{staticClass:"iconfont",class:[(_vm.layer || _vm.mlayer)?'icon-arrow-up':'icon-arrow-down']})]),_c('div',{staticClass:"q-select-left"},[_c('div',{staticClass:"q-select-input",attrs:{"placeholder":_vm.placeholder,"contenteditable":_vm.fixSearch()},domProps:{"textContent":_vm._s(_vm.text)},on:{"click":function($event){$event.stopPropagation();return _vm.lClick($event)},"input":function($event){$event.stopPropagation();return _vm.input($event)},"focus":function($event){$event.stopPropagation();return _vm.focus($event)}}}),_c('label',{staticClass:"q-select-hover"})])]),(_vm.layer)?_c('div',{staticClass:"q-select-layer",class:[_vm.layerStyle.bottom?'bottom':'top'],style:({width:_vm.layerStyle.width + 'px',top:_vm.layerStyle.top + 'px',left:_vm.layerStyle.left + 'px','--end':_vm.layerStyle.end + 'px','--start':_vm.layerStyle.start + 'px','max-height':_vm.layerStyle.height+'px','height':_vm.layerStyle.height+'px','z-index':_vm.zIndex})},[_c('ul',{on:{"click":function($event){$event.stopPropagation();return _vm.liClick($event)}}},[(_vm.search)?_c('li',{directives:[{name:"show",rawName:"v-show",value:(!_vm.regex),expression:"!regex"}],staticClass:"compare",class:[!_vm.regex?'only-last-li':'']},[_c('div',{staticClass:"op-left"},[_vm._v("无筛选匹配数据")])]):_vm._e(),(_vm.empty && _vm.layerStyle.bottom)?_c('li',{directives:[{name:"show",rawName:"v-show",value:((_vm.sModel.indexOf('s') < 0)),expression:"(sModel.indexOf('s') < 0)"}],staticClass:"empty"},[_c('div',{staticClass:"op-left"},[_vm._v("请选择")])]):_vm._e(),_vm._l((_vm.tdata),function(item,index){return [_c('li',{directives:[{name:"show",rawName:"v-show",value:(!(item.visible == false)),expression:"!(item.visible == false)"}],key:item.text,class:[item.checked?'active':'',!(item.visible == false)?'visible':'unvisible'],attrs:{"val":JSON.stringify(item),"index":index}},[_c('div',{staticClass:"op-right"},[(_vm.multy)?_c('i',{staticClass:"iconfont",class:[item.checked?'icon-checkbox-checked':'icon-checkbox']}):_c('i',{staticClass:"iconfont",class:[item.checked?'icon-radio-checked':'icon-radio']})]),_c('div',{staticClass:"op-left"},[_vm._v(_vm._s(item.text))])])]}),(_vm.empty && !_vm.layerStyle.bottom)?_c('li',{directives:[{name:"show",rawName:"v-show",value:((_vm.sModel.indexOf('s') < 0)),expression:"(sModel.indexOf('s') < 0)"}],staticClass:"empty"},[_c('div',{staticClass:"op-left"},[_vm._v("请选择")])]):_vm._e()],2)]):_vm._e(),(_vm.mlayer)?_c('div',{staticClass:"m-q-select-layer",style:({height:_vm.mlayerHeight+'px'}),on:{"touchstart":_vm.ts}},[_c('div',{staticClass:"m-layer-container"},[_c('div',{staticClass:"m-layer-content"},[_c('div',{staticClass:"m-layer-botton"},[_c('div',{staticClass:"confirm",on:{"click":function($event){$event.stopPropagation();return _vm.confirmEvent($event)}}},[_vm._v("确 定")]),_c('div',{staticClass:"cancel",on:{"click":function($event){$event.stopPropagation();return _vm.cancelEvent($event)}}},[_vm._v("取 消")])]),_c('div',{staticClass:"m-layer-wrapper"},[_c('ul',[_c('li'),_c('li'),_vm._l((_vm.tdata),function(val,index){return [_c('li',{key:val.text,class:[val.checked?'m-checked':'m-unchecked'],attrs:{"val":JSON.stringify(val),"index":index},on:{"click":function($event){$event.stopPropagation();return _vm.mLiClick($event)}}},[_vm._v(_vm._s(val.text))])]}),_c('li'),_c('li')],2)]),_c('div',{staticClass:"m-layer-line"})])])]):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/select/src/main.vue?vue&type=template&id=7aba917c&
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    'value-format': {
      type: String,
      default: "1"
      /*[1,val1,val2],[2 txt1,txt2],[3,[val1,val2]],[4,[txt1,txt2]],[5,[{txt1:val1},{txt2:val2}]]  */
  ...
  data: function data() {
    return {
      ...
      datalist: function datalist() {
        var _str = JSON.stringify(this.options);
  ...
  methods: {
    ...
    trigger: function trigger(index) {
      ...
      if (_t.multy) {
        ...
        if (_t.change) {
          var _vArray = _list.filter(function (item) {
            return item.checked;
          });
    ...
    'handle-list': function handleList(val, attr) {
      var _list = this.tdata;
      attr = attr || "checked";
  ...
  mounted: function mounted() {
    ...
    var _rect = document.querySelector("#m-" + _t.id).getBoundingClientRect();
    ...
    value: {
      handler: function handler(val) {
        ...
        if (!Array.isArray(val)) {
          var _tmpArray = val.split(',');

          _tmpArray.forEach(function (v) {
            _vArray.push({
              value: v
            });
          });
